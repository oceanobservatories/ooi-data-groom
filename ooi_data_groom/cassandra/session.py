...
class SessionManager(object):
    ...
    def execute_numpy(cls, *args, **kwargs):
        """
        Modify the session row factory for this query to return results as numpy arrays
        NOT THREAD SAFE, do not execute queries on other threads while using this method.
        """
        try:
